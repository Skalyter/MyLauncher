...
import com.tiberiugaspar.mylauncher.util.Util;
...
//        browserPackage = resolveInfo.activityInfo.packageName;
    ...
    private void setListeners() {
        appDrawer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                animateStartActivity(new Intent(MainPagerActivity.this, AppDrawerActivity.class));
            }
        });
        appPhone.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                animateStartActivity(phonePackage);
            }
        });

        appMessages.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                animateStartActivity(smsPackage);
            }
        });

        appBrowser.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                animateStartActivity(browserPackage);
            }
        });
        ...
        appCamera.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                animateStartActivity(cameraPackage);
            }
        });
    }
    ...
    private class ScreenSlidePagerAdapter extends FragmentStateAdapter {
        ...
        public int getItemCount() {
            return Util.getNumberOfPages(getApplicationContext())+2;
        }
    }
}